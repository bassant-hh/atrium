  ...
  if (!isInitialized) {
    ...
    app.enableCors({
      origin: [
        ...
        'https://atrium-frontend-react-fsejsbtph-bassant-hhs-projects.vercel.app',
        'https://atrium-frontend-react.vercel.app',
        'https://atrium-frontend-angular-mu.vercel.app',
